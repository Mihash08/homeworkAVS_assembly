...
global  typeSphere
global  typeRegularTetraheadron
global  typeParallelepiped

%include "macros.mac"

section .data
    typeSphere               dq  1
    typeRegularTetraheadron  dq  2
    typeParallelepiped       dq  3
    oneDouble                dq  1.0
...
section .bss
    ...
    cont        resb    200000  ; Массив используемый для хранения данных
